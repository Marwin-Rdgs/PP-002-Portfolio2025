...
<template>
    <RouterLink :to="`/projects/${project.id}`" class="group w-[128px] h-[180px] relative overflow-hidden phone:px-[50%] desktop:px-[10%] rounded-xl border-2 border-primary-color border-opacity-15">
