      ...
      <div class="p-4 relative">
        ...
        <div class="desktop:flex phone:grid justify-center gap-[20%] mt-6">
          <RouterLink to="/contact">
            <button class="bg-light-color rounded-full desktop:px-[64px] phone:px-[10px] phone:text-sm desktop:text-lg py-[4%] text-center font-Primary font-bold drop-shadow-lg hover:scale-110 hover:-translate-y-2 hover:shadow-secondary-color hover:shadow-lg transition-all ease-in-out duration-300">
              Voir mon profil
            </button>
          </RouterLink>
          <RouterLink to="/about">
