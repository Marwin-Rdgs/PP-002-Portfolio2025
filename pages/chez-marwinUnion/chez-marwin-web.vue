<template>
    ...
    <div class="container mx-auto flex flex-col items-start desktop:flex-row my-12 md:my-24">
      <div class="flex flex-col w-full sticky desktop:top-36 desktop:w-1/3 mt-2 desktop:mt-12 px-8">
        ...
        <p class="text-3xl desktop:text-4xl leading-normal desktop:leading-relaxed mb-2">Working Process of Fest</p>
      ...
      <div class="ml-0 md:ml-12 lg:w-2/3 sticky">
        <div class="container mx-auto w-full h-full">
          <div class="relative wrap overflow-hidden p-10 h-full">
            ...
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
              ...
              <div class="order-1 w-5/12 px-1 py-4 text-right">
                ...
                <h4 class="mb-3 font-bold text-lg desktop:text-2xl">Registration</h4>
            ...
            <div class="mb-8 flex justify-between items-center w-full right-timeline">
              ...
              <div class="order-1  w-5/12 px-1 py-4 text-left">
                ...
                <h4 class="mb-3 font-bold text-lg desktop:text-2xl">Participation</h4>
                <p class="text-sm desktop:text-base leading-snug text-gray-50 text-opacity-100">
            ...
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
              ...
              <div class="order-1 w-5/12 px-1 py-4 text-right">
                ...
                <h4 class="mb-3 font-bold text-lg desktop:text-2xl">Result Declaration</h4>
                <p class="text-sm desktop:text-base leading-snug text-gray-50 text-opacity-100">
            ...
            <div class="mb-8 flex justify-between items-center w-full right-timeline">
              ...
              <div class="order-1  w-5/12 px-1 py-4">
                ...
                <h4 class="mb-3 font-bold  text-lg desktop:text-2xl text-left">Prize Distribution</h4>
                <p class="text-sm desktop:text-base leading-snug text-gray-50 text-opacity-100">
          ...
          <img class="mx-auto -mt-36 desktop:-mt-36" src="https://user-images.githubusercontent.com/54521023/116968861-ef21a000-acd2-11eb-95ac-a34b5b490265.png" />
        </div>
      </div>
    </div>
  </div>
