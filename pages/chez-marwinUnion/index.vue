...
<template>
    <section class="flex justify-center items-center gap-[2%] mt-[6%] animate-pulse w-[90%] mx-auto">
        <img src="/imgs/Chez-MarwinUnion/CMU.svg" alt="" class="w-[128px] animate-fadeIn">
        <h1 class="font-Primary text-8xl text-primary-color drop-shadow-lg animate-fadeIn">Chez Marwin-Union</h1>
    </section>
    ...
    <section class="grid grid-cols-2 mx-[4%] gap-[10%]">

        <div class="grid mx-auto gap-y-[4%]">
            <div class="flex justify-center items-center gap-[2%]">
                <img src="/imgs/Chez-MarwinUnion/CMW.svg" alt="" class="w-[64px] animate-fadeIn">
        ...
        <div class="grid mx-auto gap-y-[4%]">
            <div class="flex justify-center items-center gap-[2%]">
                <img src="/imgs/Chez-MarwinUnion/CMTC.svg" alt="" class="w-[64px] animate-fadeIn">
