...
<template>
    ...
    <section aria-label="Redirection à l'histoire de Marwin RODRIGUES" class="relative grid desktop:grid-cols-2 phone:mt-[60%] desktop:mt-[20%]">
      <div class="grid gap-[6%] ml-[4%]">
        ...
        <NuxtLink to="/a-propos"><button class="bg-primary-color text-dark-color rounded-full desktop:px-[24px] phone:px-[10px] phone:text-sm desktop:text-lg py-[1%] text-center font-Primary font-bold drop-shadow-lg hover:scale-110 hover:translate-x-6 hover:shadow-secondary-color hover:shadow-lg transition-all ease-in-out duration-500">Savoir plus</button></NuxtLink>      
      </div>

      <img loading="lazy" src="/imgs/Marwin/Marwin-IndexBio.png" alt="Image de Marwin RODRIGUES" class=" desktop:absolute desktop:right-0 desktop:-top-64 object-cover z-0">
    ...
    <section aria-label="Liste des projets de Marwin RODRIGUES" class="desktop:mt-[10%] phone:mt-[20%]">
      ...
      <div class="bg-[url(/imgs/projects/LaetitiaDornier/LaetitiaDornier.png)] bg-cover bg-center mt-[1%] h-[100%]">
        <div class="grid items-center bg-light-color bg-opacity-5 rounded-r-full w-[50%] pl-[2%] pr-[4%] pt-[4%] h-[500px]">
          <h2 class="desktop:text-5xl phone:text-3xl font-Primary font-bold text-primary-color drop-shadow-xl">Laetitia Dornier</h2>
          <p class="desktop:text-lg phone:text-base font-Secondary font-medium text-light-color drop-shadow-md">Site web promotionnel d'une praticienne indépendante en sophrologie et réflexologie</p>
          <NuxtLink to="/projects/PC2026002"><button class="bg-primary-color text-dark-color rounded-full desktop:px-[24px] phone:px-[10px] phone:text-sm desktop:text-lg py-[1%] text-center font-Primary font-bold drop-shadow-lg hover:scale-110 hover:translate-x-6 hover:shadow-secondary-color hover:shadow-lg transition-all ease-in-out duration-500">Voir plus</button></NuxtLink>
        </div>
      </div>
    ...
    <section aria-label="FAQ page d'accueil" class="grid desktop:grid-cols-2 items-center gap-[2%] mx-[6%]">
      ...
      <div class="grid items-center gap-x-5">
        <div class="h-1/2 -mb-[20%]">
          <img loading="lazy" src="/imgs/envato/FAQ1.jpg" alt="Image d'exemple de FAQ" class="rounded-xl h-full object-cover object-top w-full items-end">
        </div>
        <div class="grid grid-cols-2 gap-[2%] items-center">
          <img loading="lazy" src="/imgs/envato/FAQ2.jpg" alt="Image d'exemple de FAQ" class="rounded-xl w-[500px] h-[250px] object-cover">
